        ...
        body: Container(
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                Align(
                  alignment: AlignmentDirectional(0.0, 4.7),
                  child: Padding(
                    padding:
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    if (_model.driverRewards == 'Missions') {
                                      _model.driverRewards = 'All';
                                      safeSetState(() {});
                                    } else {
                                ...
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    if (_model.driverRewards == 'History') {
                                      _model.driverRewards = 'All';
                                      safeSetState(() {});
                                    } else {
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Policy AXA 4621 renew in 20 days',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
